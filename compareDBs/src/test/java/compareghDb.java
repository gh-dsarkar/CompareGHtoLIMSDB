...
//@BeforeTest
//public String setfunctionSpecificDetails(){
//
//}

    
    @Test
     public void compareSNVData( ){
...
//                            Assert.assertEquals(String.valueOf(obj.get("transcript_id")),String.valueOf(LIMSObj.get("TRANSCRIPT_ID")));
//
//                            Assert.assertEquals(obj.get("cdna"),LIMSObj.get("CDNA"),"Error for record with gene "+obj.get("gene"));
//                            Assert.assertEquals(obj.get("splice_effect"),LIMSObj.get("SPLICEEFFECT"),"Error for record with gene "+obj.get("gene"));
//                            Assert.assertEquals(obj.get("call").toString(),LIMSObj.get("SNVCALL"),"Error for record with gene "+obj.get("gene"));
//                            Assert.assertEquals(obj.get("analysis_version"),LIMSObj.get("ANALYSISVERSION"),"Error for record with gene "+obj.get("gene"));
//                            Assert.assertEquals(obj.get("tb_code".toString()),LIMSObj.get("TBCODE"),"Error for record with gene "+obj.get("gene"));
//
//
...
//                            Assert.assertEquals(obj.get("mol_cnt").toString(),LIMSObj.get("MOL_CNT").toString(),"Error for record with gene "+obj.get("gene"));
//                            Assert.assertEquals(obj.get("reporting_category").toString(),LIMSObj.get("REPORTING_CATEGORY"),"Error for record with gene "+obj.get("gene"));
//                            Assert.assertEquals(obj.get("exon").toString(),LIMSObj.get("EXON"),"Error for record with gene "+obj.get("gene"));
//                            Assert.assertEquals(obj.get("somatic_call"),LIMSObj.get("SOMATIC_CALL"),"Error for record with gene "+obj.get("gene"));
//                            Assert.assertEquals(obj.get("somatic_review"),LIMSObj.get("SOMATIC_REVIEW"),"Error for record with gene "+obj.get("gene"));
//                            Assert.assertEquals(obj.get("somatic_score"),LIMSObj.get("SOMATIC_SCORE"),"Error for record with gene "+obj.get("gene"));
//                            Assert.assertEquals(obj.get("somatic_call"),LIMSObj.get("LIMS_SOMATIC_CALL"),"Error for record with gene "+obj.get("gene"));
//                            Assert.assertEquals(obj.get("tumor_call"),LIMSObj.get("TUMORCALL"),"Error for record with gene "+obj.get("gene"));
//                            Assert.assertEquals(obj.get("ldt_reportable").toString(),LIMSObj.get("LDTREPORTABLE"),"Error for record with gene "+obj.get("gene"));
//                            Assert.assertEquals(obj.get("clinvar_clinsig"),LIMSObj.get("CLINVAR_CLINSIG"),"Error for record with gene "+obj.get("gene"));
//                            Assert.assertEquals(obj.get("molecular_consequence"),LIMSObj.get("MOLECULAR_CONSEQUENCE"),"Error for record with gene "+obj.get("gene"));
//                            Assert.assertEquals(obj.get("functional_impact"),LIMSObj.get("FUNCTIONAL_IMPACT"),"Error for record with gene "+obj.get("gene"));
//                            Assert.assertEquals(obj.get("mutant_allele_status"),LIMSObj.get("MUTANT_ALLELE_STATUS"),"Error for record with gene "+obj.get("gene"));
//                            Assert.assertEquals(obj.get("clinvar_id"),LIMSObj.get("CLINVAR_ID"),"Error for record with gene "+obj.get("gene"));
//                            Assert.assertEquals(obj.get("grs_var_ntd_score"),LIMSObj.get("GRS_SCORE"),"Error for record with gene "+obj.get("gene"));
//                            Assert.assertEquals(obj.get("grs_used"),LIMSObj.get("GRS_USED"),"Error for record with gene "+obj.get("gene"));
//                            Assert.assertEquals(obj.get("tvf_call_multitumor"),LIMSObj.get("TVF_CALLED"),"Error for record with gene "+obj.get("gene"));
//                            Assert.assertEquals(obj.get("ruo_reportable").toString(),LIMSObj.get("RUOREPORTABLE").toString(),"Error for record with gene "+obj.get("gene"));
                        ...
                        System.out.println(obj.get("gene"));
                        e.printStackTrace();
                    }
...
//                        SoftAssert softAssert = new SoftAssert();
                        ...
                        String comment = obj.get("variant_comment")==null ? "":(obj.get("variant_comment").toString().replaceAll(";",","));
//                        Assert.assertEquals(obj.get("run_sample_id"),LIMSObj.get("SAMPLEID"),"Error for record with gene "+obj.get("gene")+ " SAMPLEID");
//                        Assert.assertEquals(obj.get("runid"),LIMSObj.get("RUNID"),"Error for record with gene "+obj.get("gene")+ " RUNID");
//                        Assert.assertEquals(obj.get("gene"),LIMSObj.get("GENE"),"Error for record with gene "+obj.get("gene")+ " GENE");
//
//                        //SD Value not matching
//                        Assert.assertEquals((new DecimalFormat("0.0000000").format(obj.get("sd"))).toString(),((BigDecimal)LIMSObj.get("SD")).round(new MathContext(6)).toString(),"Error for record with gene "+obj.get("gene")+ " SD");
//                        Assert.assertEquals(obj.get("zscore").toString(),LIMSObj.get("ZSCORE").toString(),"Error for record with gene "+obj.get("gene")+ " ZSCORE");
//
//                        //Round of required
//                        Assert.assertEquals((new DecimalFormat("0.0000000").format(obj.get("mean"))).toString(),((BigDecimal)LIMSObj.get("MEAN")).round(new MathContext(7)).toString(),"Error for record with gene "+obj.get("gene")+ " MEAN");
//
//                        Assert.assertEquals(((BigDecimal)LIMSObj.get("COPYNUMBER")).stripTrailingZeros().longValue(),((BigDecimal)obj.get("copy_number")).stripTrailingZeros().longValue(),"Error for record with gene "+obj.get("gene")+ " COPYNUMBER");
//
//                        Assert.assertEquals(Math.round((Float) obj.get("p_value")),((BigDecimal)LIMSObj.get("PVALUE")).stripTrailingZeros().intValue(),"Error for record with gene "+obj.get("gene")+ " PVALUE");
//                        Assert.assertEquals(obj.get("call").toString(),LIMSObj.get("CNVCALL"),"Error for record with gene "+obj.get("gene")+ " CNVCALL");
//                        Assert.assertEquals(obj.get("tb_code"),((BigDecimal)LIMSObj.get("TBCODE")).intValue(),"Error for record with gene "+obj.get("gene")+ " TBCODE");
//                        Assert.assertEquals(comment,LIMSObj.get("VARIANTCOMMENT"),"Error for record with gene "+obj.get("gene")+ " VARIANTCOMMENT");
//                        Assert.assertEquals(obj.get("analysis_version"),LIMSObj.get("ANALYSISVERSION"),"Error for record with gene "+obj.get("gene")+ " ANALYSISVERSION");
//                        Assert.assertEquals(obj.get("chrom"),LIMSObj.get("CHROMOSOME"),"Error for record with gene "+obj.get("gene")+ " CHROMOSOME");
//                        Assert.assertEquals(obj.get("ldt_reportable").toString(),LIMSObj.get("LDTREPORTABLE"),"Error for record with gene "+obj.get("gene")+ " LDTREPORTABLE");
//                        Assert.assertEquals(obj.get("ruo_reportable"),((BigDecimal)LIMSObj.get("RUOREPORTABLE")).intValue(),"Error for record with gene "+obj.get("gene")+ " RUOREPORTABLE");
...
//                        Assert.assertEquals(obj.get("sd").toString(),(df.format(LIMSObj.get("SD"))).toString(),"Error for record with gene "+obj.get("gene")+ " sd");
...
@Test
    public void compareFusionData( ){
        //Fails in Direction_A ,direction_b,orientation_gene_a,orientation_gene_b
        ghDBSpecific ghdb = new ghDBSpecific();
...
//                        Assert.assertEquals(obj.get("orientation_gene_b"),LIMSObj.get("ORIENTATION_GENE_B"),"Error for record with gene "+obj.get("gene_a")+ " orientation_gene_b");
    ...
    @Test
    public void compareDeletionData(){
        ...
        LIMSDataMap.forEach(limsItem->{
            ...
            GHDBDataMap.forEach(item->{
                ...
                try{
                    if (obj.get("gene").equals(LIMSObj.get("GENE")) ){
//                        System.out.println("Start comparision for gene"+LIMSObj.get("GENE"));
//                        String gh = obj.get("runid").toString();
//                        String limsstr = LIMSObj.get("RUNID").toString();
//                        Assert.assertEquals(gh,limsstr);
//                        Assert.assertEquals(obj.get("runid").toString(),LIMSObj.get("RUNID").toString(),"Error for record with gene "+obj.get("gene")+ " runid");
//                        Assert.assertEquals(obj.get("run_sample_id").toString(),LIMSObj.get("SAMPLEID").toString(),"Error for record with gene "+obj.get("gene")+ " run_sample_id");
//                        Assert.assertEquals(obj.get("chrom"),LIMSObj.get("CHROM"),"Error for record with gene "+obj.get("gene")+ " chrom");
//                        Assert.assertEquals(obj.get("start_pos"),((BigDecimal)LIMSObj.get("START_POS")).intValue(),"Error for record with gene "+obj.get("gene")+ " start_pos");
//                        Assert.assertEquals(obj.get("end_pos"),((BigDecimal)LIMSObj.get("END_POS")).intValue(),"Error for record with gene "+obj.get("gene")+ " end_pos");
//                        Assert.assertEquals(obj.get("nprobes"),((BigDecimal)LIMSObj.get("NPROBES")).intValue(),"Error for record with gene "+obj.get("gene")+ " nprobes");
//                        Assert.assertEquals(obj.get("copy_number"),((BigDecimal)LIMSObj.get("COPY_NUMBER")).doubleValue(),"Error for record with gene "+obj.get("gene")+ " copy_number");
//                        Assert.assertEquals(obj.get("gene"),LIMSObj.get("GENE"),"Error for record with gene "+obj.get("gene")+ " gene");
//                        Assert.assertEquals(obj.get("mean"),LIMSObj.get("MEAN"),"Error for record with gene "+obj.get("gene")+ " mean");
//                        Assert.assertEquals(obj.get("sd"),LIMSObj.get("SD"),"Error for record with gene "+obj.get("gene")+ " sd");
...
//                        Assert.assertEquals(obj.get("ll1"),((BigDecimal)LIMSObj.get("LL1")).doubleValue(),"Error for record with gene "+obj.get("gene")+ " ll1");
//                        Assert.assertEquals(obj.get("ll2"),((BigDecimal)LIMSObj.get("LL2")).doubleValue(),"Error for record with gene "+obj.get("gene")+ " ll2");
//                        Assert.assertEquals(obj.get("aic_score"),LIMSObj.get("AIC_SCORE"),"Error for record with gene "+obj.get("gene")+ " aic_score");
//                        Assert.assertEquals(obj.get("llr_score"),((BigDecimal)LIMSObj.get("LLR_SCORE")).doubleValue(),"Error for record with gene "+obj.get("gene")+ " llr_score");
//                        Assert.assertEquals(obj.get("call"),((BigDecimal)LIMSObj.get("CALL")).intValue(),"Error for record with gene "+obj.get("gene")+ " call");
//                        Assert.assertEquals(obj.get("cnv_type"),LIMSObj.get("CNV_TYPE"),"Error for record with gene "+obj.get("gene")+ " cnv_type");
//                        Assert.assertEquals(obj.get("nsnp"),((BigDecimal)LIMSObj.get("NSNP")).intValue(),"Error for record with gene "+obj.get("gene")+ " nsnp");
//                        Assert.assertEquals(obj.get("mutant_allele_status"),LIMSObj.get("MUTANT_ALLELE_STATUS"),"Error for record with gene "+obj.get("gene")+ " mutant_allele_status");
...
//                        Assert.assertEquals(obj.get("segment_size"),((BigDecimal)LIMSObj.get("SEGMENT_SIZE")).intValue(),"Error for record with gene "+obj.get("gene")+ " segment_size");
//                        Assert.assertEquals(obj.get("pct_gene_overlap"),((BigDecimal)LIMSObj.get("PCT_GENE_OVERLAP")).doubleValue(),"Error for record with gene "+obj.get("gene")+ " pct_gene_overlap");
//                        Assert.assertEquals(obj.get("ldt_reportable"),((BigDecimal)LIMSObj.get("LDT_REPORTABLE")).intValue(),"Error for record with gene "+obj.get("gene")+ " ldt_reportable");
//                        Assert.assertEquals(obj.get("estimated_cn"),((BigDecimal)LIMSObj.get("ESTIMATED_CN")).doubleValue() ,"Error for record with gene "+obj.get("gene")+ " estimated_cn");
//                        Assert.assertEquals(obj.get("npoints"),((BigDecimal)LIMSObj.get("NPOINTS")).intValue(),"Error for record with gene "+obj.get("gene")+ " npoints");
//                        Assert.assertEquals(obj.get("analysis_version"),LIMSObj.get("ANALYSISVERSION"),"Error for record with gene "+obj.get("gene")+ " analysis_version");
//                        Assert.assertEquals(obj.get("ruo_reportable"),((BigDecimal)LIMSObj.get("RUOREPORTABLE")).intValue(),"Error for record with gene "+obj.get("gene")+ " ruo_reportable");
...
//                    System.out.println(obj.get("gene").toString());
    ...
    @Test
    public void compareDenovoFusionData(){
...
//                    System.out.println(obj.get("gene").toString());
    ...
    @Test
    public void compareAlleleTypeßData(){
...
@Test
    public void compareSingleMethylData(){
...
//                    System.out.println(obj.get("gene").toString());
    ...
    @Test
    public void compareSampleMethylData(){
        ...
        LIMSDataMap.forEach(limsItem->{
            ...
            GHDBDataMap.forEach(item->{
                ...
                try{
                    if (obj.get("run_sample_id").equals(LIMSObj.get("SAMPLEID")) && (obj.get("methyl_score").equals(LIMSObj.get("METHYLSCORE")))){
                        Assert.assertEquals(obj.get("run_sample_id"),LIMSObj.get("SAMPLEID"),"Error for record with gene "+obj.get("run_sample_id")+ " run_sample_id");
                        Assert.assertEquals(obj.get("runid"),LIMSObj.get("RUNID"),"Error for record with gene "+obj.get("run_sample_id")+ " runid");
                        Assert.assertEquals(obj.get("model_name"),LIMSObj.get("MODELNAME"),"Error for record with gene "+obj.get("run_sample_id")+ " model_name");
                        Assert.assertEquals(obj.get("methyl_score"),LIMSObj.get("METHYLSCORE"),"Error for record with gene "+obj.get("run_sample_id")+ " methyl_score");
                        Assert.assertEquals(obj.get("threshold"),(new Integer((int)LIMSObj.get("THRESHOLD")).doubleValue()),"Error for record with gene "+obj.get("run_sample_id")+ " threshold");
                        Assert.assertEquals(obj.get("call"),LIMSObj.get("CALL"),"Error for record with gene "+obj.get("run_sample_id")+ " call");
                        Assert.assertEquals(obj.get("pred_type"),LIMSObj.get("PREDTYPE"),"Error for record with gene "+obj.get("run_sample_id")+ " pred_type");
                        Assert.assertEquals(obj.get("pred_frac"),LIMSObj.get("PREDTF"),"Error for record with gene "+obj.get("run_sample_id")+ " pred_frac");
                        Assert.assertEquals(obj.get("analysis_version"),LIMSObj.get("ANALYSISVERSION"),"Error for record with gene "+obj.get("run_sample_id")+ " analysis_version");
