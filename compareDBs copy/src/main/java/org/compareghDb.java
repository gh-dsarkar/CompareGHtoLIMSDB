    ...
    public static void compareSampleMethylData(){
        ...
        LIMSDataMap.forEach(limsItem->{
            ...
            GHDBDataMap.forEach(item->{
                ...
                try{
                    if (obj.get("run_sample_id").equals(LIMSObj.get("SAMPLEID")) && (obj.get("methyl_score").equals(LIMSObj.get("METHYLSCORE"))) && (obj.get("pred_type").equals(LIMSObj.get("PREDTYPE")))){
