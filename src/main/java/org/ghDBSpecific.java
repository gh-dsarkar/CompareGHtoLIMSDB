...
//        JSONArray result = null;
        ...
        String CNVQuery= "SELECT * FROM cnv_call WHERE run_sample_id = '"+sampleid+"' AND runid = '"+runid+"' AND ldt_reportable = 1 AND cnv_call.call in ( 1, 2, 3 )";
        ...
        String fusionQuery = "SELECT fc.run_sample_id run_sample_id,fc.runid, fc.downstream_gene, fc.gene_a, fc.gene_b, fc.chrom_a, fc.chrom_b, fc.pos_a," +
                ...
                "'"+sampleid+"' AND fc.runid = '"+runid+"' AND fc.ldt_reportable = 1 AND fc.call = 1";
        ...
        String denovoFusionQuery ="select fc.*,gb.denovofusion_call from denovofusion_call fc join gh_board gb on gb.run_sample_id =fc.run_sample_id  where \n" +
                ...
                "and gb.fusion_call ='PASS' and fc.\"call\" =1 and fc.ldt_reportable =1";
...
//                    "gb.sample_methyl_call  = 'PASS' and smc.\"call\" =1";
        ...
        String SampleMethylQuery = "Select (smc.*), tf.upper_limit ,tf.lower_limit  from sample_methyl_call smc \n" +
                ...
                " where smc.runid = '"+runid+"' and smc.run_sample_id ='"+sampleid+"'";
//                "smc.runid = '"+runid+"' and smc.run_sample_id ='"+sampleid+"'";
//        gb.sample_methyl_call  = 'PASS' and smc.methyl_call =1 and \n"+
            ...
            int testNumber = testsExecute.counterTest;
                switch (testNumber) {
                    case 1: //SNV
                        ...
                        break;
                    case 2:
                        System.out.println(CNVQuery);
                        rs = st.executeQuery(CNVQuery);
                        break;
                    case 3:
                    ...
                    case 9:
                        ...
                        break;
                    case 10:
                        System.out.println(SampleMethylQuery);
